...
TP_MEC_SRV_UEINFOSUB_001_OK
    ...
    vPOST    /${PX_UE_INFO_SUB_URI}    ${UE_ZONAL_TRAF_SUB_DATA}
...
TP_MEC_SRV_UEINFOSUB_001_BR
    ...
    vPOST    /${PX_UE_ZONAL_TRAF_SUB_URI}    ${UE_ZONAL_TRAF_SUB_DATA_BR}
...
TP_MEC_SRV_UEINFOSUB_002_OK
    ...
    vDELETE without e-tag    /${PX_UE_ZONAL_TRAF_SUB_URI}/${SUBSCRIPTION_ID}
...
TP_MEC_SRV_UEDISTSUB_002_NF
    ...
    vDELETE without e-tag    /${PX_UE_ZONAL_TRAF_SUB_URI}/${NON_EXISTING_SUBSCRIPTION_ID}
